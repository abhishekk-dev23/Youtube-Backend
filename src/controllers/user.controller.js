...
const registerUser = asyncHandler(async (req, res) => {
    /* 
      ...
      #swagger.parameters['fullName'] = { in: 'formData', type: 'string' }
      #swagger.parameters['email'] = { in: 'formData', type: 'string' }
      #swagger.parameters['username'] = { in: 'formData', type: 'string' }
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    if (!isPasswordValid) {
        throw new ApiError(401, "Invalid user creadentails");
    }
    ...
    return res
        ...
        .json(
            new ApiResponse(
                200,
                user[0].watchHistory,
                "watc Hhistory fetched successfully"
            )
        );
});
